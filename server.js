    ...
    if (cancelReturnMatch && req.method === 'POST') {
      ...
      try {
        if (ticket.returnAwbCourier === 'sameday') {
          await sameday.deleteAwb(ticket.returnAwbParcelId);
        } else {
