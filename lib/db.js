...
/** Sterge TOATE tichetele (si, prin cascada, comentarii/jurnal/fotografii asociate). Comenzile NU sunt afectate. */
function deleteAllTickets() {
  const countBefore = db.prepare('SELECT COUNT(*) AS c FROM tickets').get().c;
  db.prepare('DELETE FROM tickets').run();
  db.prepare("DELETE FROM section_counters").run();
