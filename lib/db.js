...
/** Lista COMPLETA, nepaginata -- folosita doar pentru export Excel. */
function listAllClients(companyId) {
...
function importClients(companyId, rows) {
  ...
  const ins = db.prepare(`
    INSERT INTO clients (id, companyId, name, phone, phoneNormalized, email, address, city, county, extraJson, createdAt)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
  `);
...
module.exports.listAllClients = listAllClients;
