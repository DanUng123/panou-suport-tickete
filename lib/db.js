...
function setTicketPickupAwb(ticketId, { awbNumber, parcelId, labelPdf, section, pickupAddress, pickupCity, pickupPostalCode, pickupPhone, courier }, actingAgent) {
  ...
  db.prepare(`
    UPDATE tickets SET pickupAwbNumber = ?, pickupAwbParcelId = ?, pickupAwbLabelPdf = ?, pickupAwbCreatedAt = ?, pickupAwbCourier = ?,
    ...
    WHERE id = ?
  `).run(
    awbNumber, String(parcelId), labelPdf || null, existing.pickupAwbCreatedAt || nowISO(), courier || 'gls', section, sectionCode, stage,
